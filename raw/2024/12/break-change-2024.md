...
> 本文记录了博主 PaloMiku 将站点整体迁移至 blog 子域名、丢弃评论与旧文、改用 Huawei Cloud EulerOS 的全过程；本文分享了“破坏型迁移”背后的动机——架构试错、域名续费到 2026-09、服务器同步续费至 2026-12，从而锁定近两年零意外停机；本文承诺在 2026 年 9 月 18 日前不再变动域名与服务器，为读者提供可预期的长期稳定访问。
