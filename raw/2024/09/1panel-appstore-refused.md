...
> 本文介绍了向 1Panel 官方应用商店提交 Ghost 博客应用却被以“与 Halo 功能重叠”为由拒绝的经过，指出官方做法有排斥竞品之嫌，易挫伤社区热情；记录了本地撰写配置文件、一键部署数据库的完整测试流程与体验；分享了作者对第三方商店仓库质量参差、手动启动繁琐的不满，并计划自建整洁仓库的后续思路，为同类 Docker 应用上架与生态选择提供参考。
