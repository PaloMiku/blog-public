...
Steam 国际中文版，史低购买游戏本体，已安装补丁。

个人在 Windows 11 和 Linux （Proton）环境运行游玩均通过测试。

## 个人进度

Steam 成就进度 100%（22/22），游戏内鉴赏模式完成度 100 %。
...
- **基本选项（随选）**：
  ...
  - 叫住美咲
  - **此时进行存档（存档点 01)**
- **仓科明日香 Asuka Kurashina**
  - **读取存档点 01（基本选项部分）**
  - ......明白了
  - **仓科明日香 Asuka Kurashina END**
- **有坂真白 Mashiro Arisaka**
  - **读取存档点 01（仓科明日香部分）**
  - 对不起，我做不到
  - **此时进行存档（存档点 02)**
  - 我想和你一起继续下去
  - **有坂真白 Mashiro Arisaka END**
- **市之濑莉佳 Rika Ichinose**
  - **读取存档点 02（有坂真白部分）**
  - 按你自己想的做就好
  - **此时进行存档（存档点 03)**
  - 如果我可以的话……我愿意
  - **市之濑莉佳 Rika Ichinose END**
- **鸢泽美咲 Misaki Tobisawa**
  - **读取存档点 03（市之濑莉佳部分）**
  - 非常抱歉，我做不到
  - 给我来训练！
  - **鸢泽美咲 Misaki Tobisawa END**
- **杂项**
  - **FINALE 在彼端的彼端 结局条件：**
  - 完成所有女主 END，会自动进入。
  - **美咲的第 5 个 Sence：**
...
- （仅PE版问题）直装版无CG鉴赏模式，移植版有全功能。
- （仅PE版问题）补丁使用方法：解压后把obb文件和游戏本体自带的obb放到一起。
- （补丁安装问题）放置在游戏目录下再一层`Aokana_Data`文件夹内。
