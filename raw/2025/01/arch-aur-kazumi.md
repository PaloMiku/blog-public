...
> 本文介绍了作者为 Flutter 番剧采集器 Kazumi 全新打包并提交 AUR 的全过程；本文记录了从痛点分析、PKGBUILD 编写到 GPG 密钥配置、PR 合并的首次打包细节；本文分享了在 Arch KDE 环境避开 Flathub 臃肿依赖、一键 `yay -S kazumi` 装机的实用方案，方便同好快速享受弹幕追番。
