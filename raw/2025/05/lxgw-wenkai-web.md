# 更换网站字体为霞鹜文楷屏幕阅读版（LXGW WenKai Screen）

> 本文介绍了如何为网站全局替换开源“霞鹜文楷”字体，记录从选字、CDN引入到CSS调用的完整流程，分享LXGW WenKai Screen版针对屏幕阅读优化的1.7.0样式文件与font-family写法，附赠Zstatic CDN链接与缓存清除技巧，一步到位实现中文楷体美化的同时保障加载速度。
